...
RegisterNetEvent('rebel-promocodes:server:createpromocode', function(args)
    ...
    elseif args.itemtype == "money" then
        if args.item:lower() == "cash" then
            ...
            sendToDiscord(16753920, " Code Created", Player.PlayerData.name.." created a code for £"..args.itemamount.." "..args.item.." with "..args.itemuses.."x uses\n\n**Code:** "..tostring(codegen).."\n**Name:** "..Player.PlayerData.name.."\n**Character Name:** "..Player.PlayerData.charinfo.firstname.." "..Player.PlayerData.charinfo.lastname.."\n**License:** "..Player.PlayerData.license.."\n**Citizenid:** "..Player.PlayerData.citizenid.."\n**Ingame ID:** "..Player.PlayerData.cid, "Made by Rebel Scripts", "created")
    ...
    elseif args.itemtype == "vehicle" then
        ...
        if givevehicle ~= nil then
            ...
            sendToDiscord(16753920, "Code Created", Player.PlayerData.name.." created a code for "..args.itemamount.."x "..givevehicle['name'].." with "..args.itemuses.."x uses\n\n**Code:** "..tostring(codegen).."\n**Name:** "..Player.PlayerData.name.."\n**Character Name:** "..Player.PlayerData.charinfo.firstname.." "..Player.PlayerData.charinfo.lastname.."\n**License:** "..Player.PlayerData.license.."\n**Citizenid:** "..Player.PlayerData.citizenid.."\n**Ingame ID:** "..Player.PlayerData.cid, "Made by Rebel Scripts", "created")
        else
            ...
            if result[1].type == "item" then
                if result[1].uses >= 1 then
                    ...
                    if not hasalreadyredeemed then
                        ...
                        sendToDiscord(16753920, "Code Redeemed", Player.PlayerData.name.." redeemed "..result[1].amount.."x "..QBCore.Shared.Items[result[1].item]['label'].." | There are "..(result[1].uses - 1).." uses left\n\n**Code:** "..args[1].."\n**Name:** "..Player.PlayerData.name.."\n**Character Name:** "..Player.PlayerData.charinfo.firstname.." "..Player.PlayerData.charinfo.lastname.."\n**License:** "..Player.PlayerData.license.."\n**Citizenid:** "..Player.PlayerData.citizenid.."\n**Ingame ID:** "..Player.PlayerData.cid, "Made by Rebel Scripts", "redeemed")
                    else
            ...
            elseif result[1].type == "money" then
                if result[1].uses >= 1 then
                    ...
                    if not hasalreadyredeemed then
                        ...
                        Player.Functions.AddMoney(result[1].item, result[1].amount, 'PROMOCODES: Promocode Redeemed')
                        ...
                        sendToDiscord(16753920, "Code Redeemed", Player.PlayerData.name.." redeemed £"..result[1].amount.." "..result[1].item.." | There are "..(result[1].uses - 1).." uses left\n\n**Code:** "..args[1].."\n**Name:** "..Player.PlayerData.name.."\n**Character Name:** "..Player.PlayerData.charinfo.firstname.." "..Player.PlayerData.charinfo.lastname.."\n**License:** "..Player.PlayerData.license.."\n**Citizenid:** "..Player.PlayerData.citizenid.."\n**Ingame ID:** "..Player.PlayerData.cid, "Made by Rebel Scripts", "redeemed")
                    else
                        TriggerClientEvent("QBCore:Notify", src, "You have already redeemed this code...", "error", 6000)
                    end
                end
...
RegisterNetEvent('rebel-promocodes:server:redeemvehicle', function(args)
    ...
    if args.result.uses >= 1 then
        ...
        if not hasalreadyredeemed then
            ...
            sendToDiscord(16753920, "Code Redeemed", Player.PlayerData.name.." redeemed "..args.result.amount.."x "..QBCore.Shared.Vehicles[args.result.item]['name'].." | There are "..(args.result.uses - 1).." uses left\n\n**Code:** "..args.args.."\n**Name:** "..Player.PlayerData.name.."\n**Character Name:** "..Player.PlayerData.charinfo.firstname.." "..Player.PlayerData.charinfo.lastname.."\n**License:** "..Player.PlayerData.license.."\n**Citizenid:** "..Player.PlayerData.citizenid.."\n**Ingame ID:** "..Player.PlayerData.cid, "Made by Rebel Scripts", "redeemed")
        else
            TriggerClientEvent("QBCore:Notify", src, "You have already redeemed this code...", "error", 6000)
        end
    end
...
RegisterNetEvent('rebel-promocodes:server:giveitemwithcode', function(citizenid, type, item, amount, uses, wherefrom, code)
    ...
    if type:lower() == "vehicle" then
        ...
        if givevehicle ~= nil then
            ...
            sendToDiscord(16753920, "Code Created", ""..amount.."x "..givevehicle['name'].." with "..uses.."x uses\n\n**Code:** "..tostring(code).."\n**Code created from:** "..wherefrom, "Made by Rebel Scripts", "created")
        else
            TriggerClientEvent("QBCore:Notify", src, "There is no such vehicle", "error", 3000)
        end
    elseif type:lower() == "item" then
        ...
        if giveitem ~= nil then
           ...
           sendToDiscord(16753920, "Code Created", ""..amount.."x "..giveitem['label'].." with "..uses.."x uses\n\n**Code:** "..tostring(code).."\n**Code created from:** "..wherefrom, "Made by Rebel Scripts", "created")
        else
    ...
    elseif type:lower() == "money" then
        if item:lower() == "cash" then
            ...
            sendToDiscord(16753920, "Code Created", "£"..amount.." Cash".." with "..uses.."x uses\n\n**Code:** "..tostring(code).."\n**Code created from:** "..wherefrom, "Made by Rebel Scripts", "created")
        elseif item:lower() == "bank" then
            ...
            sendToDiscord(16753920, "Code Created", "£"..amount.." Bank".." with "..uses.."x uses\n\n**Code:** "..tostring(code).."\n**Code created from:** "..wherefrom, "Made by Rebel Scripts", "created")
        end
    end
end)
