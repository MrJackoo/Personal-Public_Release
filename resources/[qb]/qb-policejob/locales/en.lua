local Translations = {
    error = {
        license_already = 'Subject already has a license',
        error_license = 'Subject doesn\'t have that license',
        ...
        not_cuffed_dead = 'Subject isn\'t cuffed or dead',
    },
    success = {
    ...
    info = {
        ...
        fingerprint_text = '[~b~F~w~] Fingerprint',
        fingerprint = 'Fingerprint',
        store_heli = '[E] Store Helicopter',
        store_polcar = '[E] Store Vehicle',
        take_heli = '[E] NPAS Helipad',
        take_polcar = '[E] Police Garage',
