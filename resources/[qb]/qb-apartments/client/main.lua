			...
			options = {
				{
					...
					action = function(entity)
						TriggerEvent("qb-apartments:client:TriggerMenu", v.name)
					end,
...
RegisterNetEvent("apartments:client:RaidApartment", function(apartment, apartmentId, retval)
	EnterApartment(apartment, apartmentId)
end)

RegisterNetEvent("qb-apartments:client:TriggerMenu", function(name)
