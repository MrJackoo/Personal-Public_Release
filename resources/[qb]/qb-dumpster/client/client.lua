...
RegisterNetEvent("qb-dumpster:Dive")
AddEventHandler('qb-dumpster:Dive', function()
    listening = true
            ...
            --if IsControlJustReleased(0, 54) then
                for i = 1, #searched do
                    ...
                    elseif i == #searched and not dumpsterFound then
                        ...
                        QBCore.Functions.Progressbar("dumpsters", "Searching Dumpster", searchTime, false, false, {
