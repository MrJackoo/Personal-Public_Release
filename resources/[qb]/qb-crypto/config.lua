Crypto = {
    ...
    Exchange = {
        coords = vector3(1275.54, -1710.48, 54.77),
        RebootInfo = {
            state = false,
            percentage = 0
        },
    ...
    -- Crashes or luck
    ChanceOfCrashOrLuck = 15, -- This is in % (1-100)
    Crash = {20,80}, -- Min / Max
    Luck = {20,45}, -- Min / Max
...
Ticker = {
    ...
    Api_key = 'api_key_here', -- If you decide to get an api key for the API (https://min-api.cryptocompare.com/pricing) The free plan should be more than enough for 1 Fivem server
