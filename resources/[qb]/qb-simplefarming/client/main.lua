  ...
  CreateThread(function()
    for k in pairs(PumpkinField) do
      local PumpkinFarmingBlip = AddBlipForCoord(PumpkinField[k].BlipCoord)
        ...
        SetBlipScale(PumpkinFarmingBlip, 0.65)
...
RegisterNetEvent('qb-simplefarming:pumpkinfarming', function()
  ...
  QBCore.Functions.Progressbar("picking_pumpkins", Config.Alerts['picking_pumpkins'], 6000, false, true, {
      disableMovement = true,
      disableCarMovement = true,
      disableMouse = false,
      disableCombat = true,
