...
RegisterNetEvent('qb-simpefarming:sellItems', function()
    ...
    if Player.PlayerData.items ~= nil and next(Player.PlayerData.items) ~= nil then
        ...
        Player.Functions.AddMoney("cash", price, 'Farming Pay')
        TriggerClientEvent('QBCore:Notify', source, "You have sold your items")
        TriggerEvent("qb-log:server:CreateLog", "jobpay", "Farming Produce", "green", "**"..Player.PlayerData.charinfo.firstname .. " ".. Player.PlayerData.charinfo.lastname.. "** [ "..GetPlayerName(source) .. " - Citizen ID: "..Player.PlayerData.citizenid.." | ID: "..Player.PlayerData.source.." ] has received **£" .. price .. "** for selling farm produce")
    else
...
RegisterServerEvent('qb-simplefarming:pigfood', function()
    ...
    Player.Functions.RemoveMoney("cash", price, 'Farming: Pig Feed Purchase')
