...
AddEventHandler('playerDropped', function()
    local src = source
    local srcDiscord = ExtractIdentifiers(src)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'joinleave', 'Player Disconnected', 'red', '**'.. GetPlayerName(src) .. '**\nName:** '..firstname.. ' '..lastname.. '**\n Discord **<@'..srcDiscord.discord:gsub('discord:', '').. '>**\nLicense:** ' ..(QBCore.Functions.GetIdentifier(src, 'license') or 'undefined') ..'**\nCitizen ID:** ' ..citizenid..'**\nID:** '..src..'**')
