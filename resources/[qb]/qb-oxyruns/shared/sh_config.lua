...
Config.StartLocation = vector4(-808.85, 175.85, 76.74, 282.54) -- Start location for oxy run
Config.RunAmount = math.random(7, 10) -- How many drop-offs the player can make each run.
Config.StartOxyPayment = 20000 -- How much you pay at the start to start the run

Config.MinCops = 2 -- Minimum required amount of cops
Config.CallCopsChance = 75 -- %Chance to alert police

Config.OxyChance = 40 -- %Chance to receive oxy
Config.OxyItem = 'oxy'

Config.RareLoot = 1 -- %Chance to receive a rare loot item
Config.RareLootItem = 'boostinglaptop' -- Rare loot item
