Config.Sitable = {
	...
	ba_prop_battle_club_chair_01			= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -0.5, forwardOffset = 0.0, leftOffset = 0.0},
	...
	bs_ab_dinerbench						= { scenario = 'PROP_HUMAN_SEAT_BENCH', verticalOffset = -1.0, forwardOffset = 0.0, leftOffset = 0.0},
}
