...
RegisterNetEvent('vehicle:flipit', function()
    ...
    if not IsPedInAnyVehicle(ped, false) then
        if DoesEntityExist(vehicle) and not IsVehicleOnAllWheels(vehicle) then
            QBCore.Functions.Progressbar('unflip_veh', 'Unflipping Vehicle', 30000, false, true, {
