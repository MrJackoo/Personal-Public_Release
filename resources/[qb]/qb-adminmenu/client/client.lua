        ...
        if rank then
            ...
            menu10:AddSlider({
                ...
                change = function(_, newValue, _)
                    ...
                    elseif vcal == 2 then
                        selectedgroup = {}
                        selectedgroup[#selectedgroup+1] = {rank = "supportstaff", label = "Support Staff"}
                    elseif vcal == 3 then
                        selectedgroup = {}
                        selectedgroup[#selectedgroup+1] = {rank = "moderator", label = "Moderator"}
                    elseif vcal == 4 then
                        selectedgroup = {}
                        selectedgroup[#selectedgroup+1] = {rank = "admininistrator", label = "Administrator"}
                    elseif vcal == 5 then
                        selectedgroup = {}
                        selectedgroup[#selectedgroup+1] = {rank = "senioradministrator", label = "Senior Administrator"}
                    elseif vcal == 6 then
                        selectedgroup = {}
                        selectedgroup[#selectedgroup+1] = {rank = "stafflead", label = "Staff Lead"}
                    end
                end
            })
...
menu_button5:On('change', function(_, _, _)
    ...
    local adminmane = Player.charinfo.firstname .. " " .. Player.charinfo.lastname
    
    TriggerServerEvent('qb-log:server:CreateLog', 'staff', 'ADMIN MENU', "red", '**'.. GetPlayerName() .. '** (citizenid: *'..Player.citizenid..'* | id: *'..serverid..'* Char Name: *'..adminmane..'* ) **Has Toggled Noclip **')
...
menu_button6:On('select', function(_)
    ...
    TriggerServerEvent('qb-log:server:CreateLog', 'staff', 'ADMIN MENU', "red", '**'.. GetPlayerName() .. '** (citizenid: *'..Player.citizenid..'* | id: *'..serverid..'* Char Name: *'..adminmane..'* ) **Has Revived Themselves **')
end)
...
menu_button7:On('change', function(_, _, _)
    ...
    TriggerServerEvent('qb-log:server:CreateLog', 'staff', 'ADMIN MENU', "red", '**'.. GetPlayerName() .. '** (citizenid: *'..Player.citizenid..'* | id: *'..serverid..'* Char Name: *'..adminmane..'* ) **Has Toggled Invisibility **')
end)
...
menu_button8:On('change', function(_, _, _)
    ...
    TriggerServerEvent('qb-log:server:CreateLog', 'staff', 'ADMIN MENU', "red", '**'.. GetPlayerName() .. '** (citizenid: *'..Player.citizenid..'* | id: *'..serverid..'* Char Name: *'..adminmane..'* ) **Has Toggled Godmode **')
end)
