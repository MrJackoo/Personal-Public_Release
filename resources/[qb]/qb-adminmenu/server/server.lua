...
QBCore.Functions.CreateCallback('qb-admin:server:getrank', function(source, cb)
    if QBCore.Functions.HasPermission(source, 'stafflead') or IsPlayerAceAllowed(source, 'staff.getrank') then
        cb(true)
    else
        cb(false)
    end
...
RegisterNetEvent('qb-admin:server:kill', function(player)
    ...
    local admincharname = Admin.PlayerData.charinfo.firstname .. " " .. Admin.PlayerData.charinfo.lastname
    local TargetName = Target.PlayerData.charinfo.firstname .. " " .. Target.PlayerData.charinfo.lastname

    TriggerEvent('qb-log:server:CreateLog', 'staff', 'ADMIN MENU', "red", '**'.. GetPlayerName(source) .. '** (citizenid: *'..Admin.PlayerData.citizenid..'* | id: *'..source..'* Char Name: *'..admincharname..'* ) **Has Killed: **'..TargetName)
...
RegisterNetEvent('qb-admin:server:revive', function(player)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'staff', 'ADMIN MENU', "red", '**'.. GetPlayerName(source) .. '** (citizenid: *'..Admin.PlayerData.citizenid..'* | id: *'..source..'* Char Name: *'..admincharname..'* ) **Has Revive: **'..TargetName)

end)

RegisterNetEvent('qb-admin:server:kick', function(player, reason)
    local src = source
    if QBCore.Functions.HasPermission(src, permissions['kick']) or IsPlayerAceAllowed(src, 'staff.kick')  then
...
RegisterNetEvent('qb-admin:server:ban', function(player, time, reason)
    local src = source
    if QBCore.Functions.HasPermission(src, permissions['ban']) or IsPlayerAceAllowed(src, 'staff.ban') then
        time = tonumber(time)
...
RegisterNetEvent('qb-admin:server:spectate', function(player)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'staff', 'ADMIN MENU', "red", '**'.. GetPlayerName(source) .. '** (citizenid: *'..Admin.PlayerData.citizenid..'* | id: *'..source..'* Char Name: *'..admincharname..'* ) **Toggled Spectate on: **'..TargetName)
...
RegisterNetEvent('qb-admin:server:freeze', function(player)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'staff', 'ADMIN MENU', "red", '**'.. GetPlayerName(source) .. '** (citizenid: *'..Admin.PlayerData.citizenid..'* | id: *'..source..'* Char Name: *'..admincharname..'* ) **Has Frozen/Unfrozen: **'..TargetName)
...
RegisterNetEvent('qb-admin:server:goto', function(player)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'staff', 'ADMIN MENU', "red", '**'.. GetPlayerName(source) .. '** (citizenid: *'..Admin.PlayerData.citizenid..'* | id: *'..source..'* Char Name: *'..admincharname..'* ) **Has Teleported to: **'..TargetName..' At Coords: '..coords)
...
RegisterNetEvent('qb-admin:server:intovehicle', function(player)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'staff', 'ADMIN MENU', "red", '**'.. GetPlayerName(source) .. '** (citizenid: *'..Admin.PlayerData.citizenid..'* | id: *'..source..'* Char Name: *'..admincharname..'* ) **Has Entered **'..TargetName..' Vehicle ')
...
RegisterNetEvent('qb-admin:server:bring', function(player)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'staff', 'ADMIN MENU', "red", '**'.. GetPlayerName(source) .. '** (citizenid: *'..Admin.PlayerData.citizenid..'* | id: *'..source..'* Char Name: *'..admincharname..'* ) **Has Teleported **'..TargetName..' to themselves at Coords: '..coords)
end)
...
RegisterNetEvent('qb-admin:server:inventory', function(player)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'staff', 'ADMIN MENU', "red", '**'.. GetPlayerName(source) .. '** (citizenid: *'..Admin.PlayerData.citizenid..'* | id: *'..source..'* Char Name: *'..admincharname..'* ) **Has Opened **'..TargetName..' Inventory')
...
RegisterNetEvent('qb-admin:server:cloth', function(player)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'staff', 'ADMIN MENU', "red", '**'.. GetPlayerName(source) .. '** (citizenid: *'..Admin.PlayerData.citizenid..'* | id: *'..source..'* Char Name: *'..admincharname..'* ) **Has Given **'..TargetName..' Clothing Menu')

end)

RegisterNetEvent('qb-admin:server:setPermissions', function(targetId, group)
    local src = source
    if QBCore.Functions.HasPermission(src, 'stafflead') or IsPlayerAceAllowed(src, 'staff.setperms') then
    ...
    TriggerEvent('qb-log:server:CreateLog', 'staff', 'ADMIN MENU', "red", '**'.. GetPlayerName(source) .. '** (citizenid: *'..Admin.PlayerData.citizenid..'* | id: *'..source..'* Char Name: *'..admincharname..'* ) **Has Changed **'..TargetName..' Permissions to: '..group[1].rank)
end)

RegisterNetEvent('qb-admin:server:Staffchat:addMessage', function(name, msg)
    local src = source
    if QBCore.Functions.HasPermission(src, 'admininistrator') or IsPlayerAceAllowed(src, 'staff.chat') then
...
RegisterServerEvent('qb-admin:giveWeapon', function(weapon)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'staff', 'ADMIN MENU', "red", '**'.. GetPlayerName(source) .. '** (citizenid: *'..Admin.PlayerData.citizenid..'* | id: *'..source..'* Char Name: *'..admincharname..'* ) **Has spawned a: **'..weapon)
...
QBCore.Commands.Add('maxmods', Lang:t("desc.max_mod_desc"), {}, false, function(source)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'staff', 'ADMIN MENU', "red", '**'.. GetPlayerName(source) .. '** (citizenid: *'..Admin.PlayerData.citizenid..'* | id: *'..source..'* Char Name: *'..admincharname..'* ) **Has Triggered Max Mods **')
...
QBCore.Commands.Add('blips', Lang:t("commands.blips_for_player"), {}, false, function(source)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'staff', 'ADMIN MENU', "red", '**'.. GetPlayerName(source) .. '** (citizenid: *'..Admin.PlayerData.citizenid..'* | id: *'..source..'* Char Name: *'..admincharname..'* ) **Has Toggled Blips **')
...
QBCore.Commands.Add('names', Lang:t("commands.player_name_overhead"), {}, false, function(source)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'staff', 'ADMIN MENU', "red", '**'.. GetPlayerName(source) .. '** (citizenid: *'..Admin.PlayerData.citizenid..'* | id: *'..source..'* Char Name: *'..admincharname..'* ) **Has Toggled Names **')
...
QBCore.Commands.Add('noclip', Lang:t("commands.toogle_noclip"), {}, false, function(source)
    ...
    TriggerEvent('qb-log:server:CreateLog', 'staff', 'ADMIN MENU', "red", '**'.. GetPlayerName(source) .. '** (citizenid: *'..Admin.PlayerData.citizenid..'* | id: *'..source..'* Char Name: *'..admincharname..'* ) **Has toggled Noclip **')
...
--[[QBCore.Commands.Add('warn', Lang:t("commands.warn_a_player"), {{name='ID', help='Player'}, {name='Reason', help='Mention a reason'}}, true, function(source, args)
    ...
    if targetPlayer ~= nil then
        target = targetPlayer.PlayerData.source
        message = msg
        playername = 'from '..GetPlayerName(source)..''
        TriggerEvent('okokChat:ServerMessage', '#027d58', '#FFFFFF', '⛔', 'AdminWarning', message, target)
...
RegisterNetEvent('qb-admin:server:SendReport', function(name, targetSrc, msg)
    ...
    if QBCore.Functions.HasPermission(src, 'administrator') or IsPlayerAceAllowed(src, 'command') then
        if QBCore.Functions.IsOptin(src) then
            playername = ''..name..' ['..targetSrc..']'
            message = msg
            target = src
            TriggerEvent('okokChat:ServerMessage', '#ff6600', '#FFFFFF', '📋', 'Report', playername, message, target)
        end
    end
end)
...
RegisterNetEvent('qb-admin:server:SendReport', function(name, targetSrc, msg)
    local src = source
    if QBCore.Functions.HasPermission(src, 'administrator') or IsPlayerAceAllowed(src, 'user.sendreport') then
        if QBCore.Functions.IsOptin(src) then
            TriggerClientEvent('chat:addMessage', src, {
                color = {255, 0, 0},
                multiline = true,
...
--[[QBCore.Commands.Add('reportr', Lang:t("commands.reply_to_report"), {{name='id', help='Player'}, {name = 'message', help = 'Message to respond with'}}, false, function(source, args)
    ...
    target = playerId
    message = msg
    TriggerEvent('okokChat:ServerMessage', '#027d58', '#FFFFFF', '💬', 'Report Reply', playername, message, target)

    TriggerClientEvent('QBCore:Notify', src, 'If you need support please make a ticket')
...
QBCore.Commands.Add('kickall', Lang:t("commands.kick_all"), {}, false, function(source, args)
    ...
    if src > 0 then
        ...
        if QBCore.Functions.HasPermission(src, 'stafflead') or IsPlayerAceAllowed(src, 'staff.kickall') then
