    ...
    if Player.PlayerData.items[data.slot] then
        if Player.PlayerData.items[data.slot].info.quality then
            if Player.PlayerData.items[data.slot].info.quality ~= 100 then
                if Player.Functions.RemoveMoney('cash', Config.WeaponRepairCosts[WeaponClass], 'Weapons: Repaired Weapon') then
...
QBCore.Commands.Add("repairweapon", "Repair Weapon (God Only)", {{name="hp", help=Lang:t('info.hp_of_weapon')}}, true, function(source, args)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    TriggerClientEvent('weapons:client:SetWeaponQuality', src, tonumber(args[1]))
    TriggerEvent("qb-log:server:CreateLog", "staff", "Staff Command", "blue", "**"..Player.PlayerData.charinfo.firstname .. " ".. Player.PlayerData.charinfo.lastname.. "** [ "..GetPlayerName(src) .. " - Citizen ID: "..Player.PlayerData.citizenid.." | ID: "..Player.PlayerData.source.." ] repaired their weapon")
...
QBCore.Functions.CreateUseableItem('trainingrounds', function(source, item)
    TriggerClientEvent('weapon:client:AddAmmo', source, 'AMMO_TRAINING', 50, item)
end)

QBCore.Functions.CreateUseableItem('taser_prongs', function(source, item)
    TriggerClientEvent('weapon:client:AddAmmo', source, 'AMMO_FAKETASER', 2, item)
end)

QBCore.Functions.CreateUseableItem('taser7_prongs', function(source, item)
...
-- Ammobox
QBCore.Functions.CreateUseableItem('pistol_ammobox', function(source, item)
    TriggerClientEvent('weapon:client:AddAmmo', source, 'AMMO_PISTOL', 50, item)
end)
QBCore.Functions.CreateUseableItem('shotgun_ammobox', function(source, item)
    TriggerClientEvent('weapon:client:AddAmmo', source, 'AMMO_SHOTGUN', 32, item)
end)
QBCore.Functions.CreateUseableItem('smg_ammobox', function(source, item)
    TriggerClientEvent('weapon:client:AddAmmo', source, 'AMMO_SMG', 50, item)
end)
QBCore.Functions.CreateUseableItem('rifle_ammobox', function(source, item)
    TriggerClientEvent('weapon:client:AddAmmo', source, 'AMMO_RIFLE', 50, item)
end)

-- Large Ammobox
QBCore.Functions.CreateUseableItem('pistol_ammoboxlarge', function(source, item)
    TriggerClientEvent('weapon:client:AddAmmo', source, 'AMMO_PISTOL', 100, item)
end)
QBCore.Functions.CreateUseableItem('shotgun_ammoboxlarge', function(source, item)
    TriggerClientEvent('weapon:client:AddAmmo', source, 'AMMO_SHOTGUN', 64, item)
end)
QBCore.Functions.CreateUseableItem('smg_ammoboxlarge', function(source, item)
    TriggerClientEvent('weapon:client:AddAmmo', source, 'AMMO_SMG', 100, item)
end)
QBCore.Functions.CreateUseableItem('rifle_ammoboxlarge', function(source, item)
    TriggerClientEvent('weapon:client:AddAmmo', source, 'AMMO_RIFLE', 100, item)
end)

-- Hunting Ammo
QBCore.Functions.CreateUseableItem("hunting_ammo", function(source, item)
    TriggerClientEvent("weapon:client:AddAmmo", source, "AMMO_HUNTING", 12, item)
end)
...
QBCore.Functions.CreateUseableItem('civglock17_mag1', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'glockmag')
end)

QBCore.Functions.CreateUseableItem('glockgen4_mag1', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'glockmag')
end)

QBCore.Functions.CreateUseableItem('glock19_mag1', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'glockmag')
end)

QBCore.Functions.CreateUseableItem('trainingglock_mag1', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'glockmag1')
end)

QBCore.Functions.CreateUseableItem('trainingglock_mag2', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'glockmag2')
end)
...
QBCore.Functions.CreateUseableItem('civuzi_mag1', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'uzimag1')
end)

QBCore.Functions.CreateUseableItem('civuzi_mag2', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'uzimag2')
end)

QBCore.Functions.CreateUseableItem('civuzi_mag3', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'uzimag3')
end)

QBCore.Functions.CreateUseableItem('civuzi_mag4', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'uzimag4')
end)

-- Scopes

QBCore.Functions.CreateUseableItem('civuzi_scope1', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'uziscope1')
end)

QBCore.Functions.CreateUseableItem('civuzi_scope2', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'uziscope2')
end)

QBCore.Functions.CreateUseableItem('civuzi_scope3', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'uziscope3')
end)

QBCore.Functions.CreateUseableItem('civuzi_scope4', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'uziscope4')
end)

QBCore.Functions.CreateUseableItem('civuzi_scope5', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'uziscope5')
end)

QBCore.Functions.CreateUseableItem('civuzi_scope6', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'uziscope6')
end)

-- Suppressors

QBCore.Functions.CreateUseableItem('civuzi_supp1', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'uzibarrel1')
end)

QBCore.Functions.CreateUseableItem('civuzi_supp2', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'uzibarrel2')
end)

-- Stocks

QBCore.Functions.CreateUseableItem('civuzi_stock1', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'uzistock1')
end)

QBCore.Functions.CreateUseableItem('civuzi_stock2', function(source, item)
    TriggerClientEvent('weapons:client:EquipAttachment', source, item, 'uzistock2')
end)
