...
Config.DurabilityMultiplier = {
    ...
    ['weapon_civglock17']           = 0.00,
    ['weapon_g17']                  = 0.00,
    ['weapon_glock19']              = 0.00,
    ['weapon_trainingglock']        = 0.00,
...
WeaponAttachments = {
    ...
    ['WEAPON_CIVGLOCK17'] = {
        ['glockmag'] = {
            component = 'COMPONENT_CIVGLOCK17_CLIP_01',
            label = "Glock 17 MAG",
            item = 'civglock17_mag1',
            type = 'clip',
        },
    },
    ...
    ['WEAPON_GLOCK19'] = {
        ['glockmag'] = {
            component = 'COMPONENT_GLOCK19_CLIP_01',
            label = "Glock 19 Mag",
            item = 'glock19_mag1',
            type = 'clip',
        },
    ...
    ['WEAPON_TRAININGGLOCK'] = {
        ['glockmag1'] = {
            component = 'COMPONENT_TRAININGGLOCK_CLIP_01',
            label = "Glock 19 Mag",
            item = 'Training Glock Mag 1',
            type = 'clip',
        },
        ['glockmag2'] = {
            component = 'COMPONENT_TRAININGGLOCK_CLIP_02',
            label = "Training Glock Mag 2",
            item = 'trainingglock_mag2',
            type = 'clip',
        },
    },
    ...
    ['WEAPON_CIVUZI'] = {
        ['uzimag1'] = {
            component = 'COMPONENT_CIVUZI_CLIP_01',
            label = "Micro Uzi Stock Magazine",
            item = 'civuzi_mag1',
            type = 'clip',
        },
        ['uzimag2'] = {
            component = 'COMPONENT_CIVUZI_CLIP_02',
            label = "Micro Uzi Stick Magazine",
            item = 'civuzi_mag2',
            type = 'clip',
        },
        ['uzimag3'] = {
            component = 'COMPONENT_CIVUZI_CLIP_03',
            label = "Micro Uzi Extended Magazine",
            item = 'civuzi_mag3',
            type = 'clip',
        },
        ['uzimag4'] = {
            component = 'COMPONENT_CIVUZI_CLIP_04',
            label = "Micro Uzi Drum Magazine",
            item = 'civuzi_mag4',
            type = 'clip',
        },
        ...
        ['uziscope1'] = {
            component = 'COMPONENT_CIVUZI_SCOPE_01',
            label = "Micro Uzi Scope 1",
            item = 'civuzi_scope1',
        },
        ['uziscope2'] = {
            component = 'COMPONENT_CIVUZI_SCOPE_02',
            label = "Micro Uzi Scope 2",
            item = 'civuzi_scope2',
        },
        ['uziscope3'] = {
            component = 'COMPONENT_CIVUZI_SCOPE_03',
            label = "Micro Uzi Scope 3",
            item = 'civuzi_scope3',
        },
        ['uziscope4'] = {
            component = 'COMPONENT_CIVUZI_SCOPE_04',
            label = "Micro Uzi Scope 4",
            item = 'civuzi_scope4',
        },
        ['uziscope5'] = {
            component = 'COMPONENT_CIVUZI_SCOPE_05',
            label = "Micro Uzi Scope 5",
            item = 'civuzi_scope5',
        },
        ['uziscope6'] = {
            component = 'COMPONENT_CIVUZI_SCOPE_06',
            label = "Micro Uzi Scope 6",
            item = 'civuzi_scope6',
        },
        ...
        ['uzibarrel1'] = {
            component = 'COMPONENT_CIVUZI_SUPP_01',
            label = "Micro Uzi Suppressor 1",
            item = 'civuzi_supp1',
        },
        ['uzibarrel2'] = {
            component = 'COMPONENT_CIVUZI_SUPP_02',
            label = "Micro Uzi Suppressor 2",
            item = 'civuzi_supp2',
        },
        ...
        ['uzistock1'] = {
            component = 'COMPONENT_CIVUZI_STOCK_01',
            label = "Micro Uzi Stock 1",
            item = 'civuzi_stock1',
        },
        ['uzistock2'] = {
            component = 'COMPONENT_CIVUZI_STOCK_02',
            label = "Micro Uzi Stock 2",
            item = 'civuzi_stock2',
        },
    },
}
