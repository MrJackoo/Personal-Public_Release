    ...
    [3] = {
        ...
        items = {
            ...
            },
            {
                ...
                icon = 'cut',
                type = 'client',
                event = 'police:client:CutZipties',
                shouldClose = true
            },
            {
                id = 'resethunting',
                            ...
                            items = {
                                {
                                    ...
                                    icon = 'hat-cowboy-side',
                                    type = 'client',
                                    event = 'qb-radialmenu:ToggleVisor',
                                    shouldClose = true
                                }, {
                                    id = 'Mask',
                                    title = 'Mask',
...
Config.JobInteractions = {
    ["ambulance"] = {
        ...
        -- },
        {
            ...
            items ={
                ...
                },
                {
                    ...
                    icon = 'syringe',
                    type = 'client',
                    event = 'hospital:client:AdministerMorphine',
                    shouldClose = true
                },
                {
                    id = 'treatwounds',
        ...
        },
        {
            ...
            items ={
                ...
                },
                {
                    ...
                    icon = 'truck-pickup',
                    type = 'client',
                    event = 'nhs:client:StartImpounding',
                    shouldClose = true
                },
            }
        },
        ...
        
        {
            ...
            icon = 'bell',
            type = 'client',            
            event = 'qb-policejob:client:ActivatePanicButton',
            shouldClose = true
        },
        -- {
        --     id = 'stretcheroptions',
        ...
        },
        {
            ...
            items ={
                ...
                },
                {
                    ...
                    icon = 'pound-sign',
                    type = 'client',
                    event = 'police:client:FinePlayer',
                    shouldClose = true
                },
                {
                    id = 'sentenceplayer',
                    title = 'Sentence Player',
                    icon = 'user-lock',
                    type = 'server',
                    event = 'police:server:SentencePlayer',
                    shouldClose = true
                },
                {
                    id = 'policegloves',
                    ...
                    icon = 'mitten',
                    type = 'client',
                    event = 'police:client:ToggleGloves',
                    shouldClose = true
                },
                {
                    id = 'policehouse',
                    title = 'Reset House Alarm',
                    icon = 'home',
                    type = 'client',
                    event = 'qb-houserobbery:client:ResetHouseState',
                    shouldClose = true
                },
            }
        },
            ...
            items ={
                {
                    ...
                    icon = 'key',
                    type = 'client',
                    event = 'keys:client:policeunlock',
                    shouldClose = true
                },
                {
                    id = 'impoundpolicecar',
                    ...
                    icon = 'truck-pickup',
                    type = 'client',
                    event = 'police:client:StartImpounding',
                    shouldClose = true
                },
                {
                    id = 'seizepolicecar',
                    title = 'Seize Vehicle (Send to Police Impound)',
                    icon = 'exclamation-triangle',
                    type = 'client',
                    event = 'police:client:SeizeCar',
                    shouldClose = true
                },
            }
        },
...
Config.Commands = {
    ...
    ["badge"] = {
        Func = function() ToggleClothing("Badge") end,
        Sprite = "badge",
        Desc = "Take your Badge off/on",
        Button = 15,
        Name = "Badge"
    }
}
