...
local function calculateFareAmount()
    if meterIsOpen and meterActive then
        ...
        if startPos ~= newPos then
            ...
            local fareAmount = (meterData['distanceTraveled'] / 1000.00) * meterData['fareAmount']
...
function setupTarget()
    CreateThread(function()
        exports['qb-target']:SpawnPed({
            ...
            coords = vector4(893.9, -167.9, 74.17, 266.47),
            minusOne = true,
            freeze = true,
            invincible = true,
            blockevents = true,
