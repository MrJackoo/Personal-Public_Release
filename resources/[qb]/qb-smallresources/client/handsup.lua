...
RegisterCommand('+handsup', function()
    ...
    if exports["qb-policejob"]:IsZiptied() then return end
    ...
    TaskPlayAnim(PlayerPedId(), animDict, anim, 2.0, -2.0, -1, 49, 0.0, false, false, false)
...
CreateThread(function()
    while true do
        ...
        if handsUp then
            ...
            DisableControlAction(0,140,true) -- disable melee (r)
