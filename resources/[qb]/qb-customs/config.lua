...
Config.DefaultRepairPrice = 1000 -- Repair price that is used if a vehicle-specific price is not available
Config.BaseRepairPrice = 50 -- Starting repair price. Every player's vehicle damage (0-1000) is added to it later. If the final price is 0 or less, the repair menu does not appear
Config.RepairPriceMultiplier = 2.0 -- Every player's vehicle damage (0-1000) is multiplier by this number, and then added to the base repair price
