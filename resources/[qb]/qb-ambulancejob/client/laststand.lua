...
InLaststand = false
LaststandTime = 0
lastStandDict = "misslamar1dead_body"
lastStandAnim = "dead_idle"
isEscorted = false
...
function SetLaststand(bool)
    ...
    if bool then
        ...
        TriggerServerEvent('cd_dispatch:AddNotification', {
            job_table = {'ambulance'}, 
            coords = data.coords,
            title = 'Category 3 - Patient Hurt',
            message = 'A ' .. data.sex .. " Patient has fallen ill at " .. data.street_1 .. " but has not requested NHS Assistance",
            flash = 0,
