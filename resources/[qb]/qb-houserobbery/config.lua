...
Config.Rewards = {
    [1] = {
        ["cabin"] = {"diamond_ring", "goldchain", "cryptostick", "weapon_golfclub"},
        ["kitchen"] = {"tosti", "sandwich", "goldchain"},
        ["chest"] = {"rolex", "diamond_ring", "goldchain", "cryptostick"},
        ["livingroom"] = {"rolex", "diamond_ring", "goldchain", "cryptostick", "tablet"}
    }
}
