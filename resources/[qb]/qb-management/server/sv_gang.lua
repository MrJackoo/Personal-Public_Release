...
RegisterNetEvent("qb-gangmenu:server:withdrawMoney", function(amount)
	...
	if RemoveGangMoney(gang, amount) then
		...
		if amount >= 25000 then
			TriggerEvent("qb-log:server:CreateLog", "bossmenu", "Funds Withdrawl ("..gang..")", "green", "**"..Player.PlayerData.charinfo.firstname .. " ".. Player.PlayerData.charinfo.lastname.. "** [ "..GetPlayerName(src) .. "(** Citizen ID: "..Player.PlayerData.citizenid.." | ID: "..Player.PlayerData.source..")** withdrew **£" .. amount .. " from the " .. gang .. " account", true)
		else
			TriggerEvent("qb-log:server:CreateLog", "bossmenu", "Funds Withdrawl ("..gang..")", "green", "**"..Player.PlayerData.charinfo.firstname .. " ".. Player.PlayerData.charinfo.lastname.. "** [ "..GetPlayerName(src) .. "(** Citizen ID: "..Player.PlayerData.citizenid.." | ID: "..Player.PlayerData.source..")** withdrew **£" .. amount .. " from the " .. gang .. " account", false)
		end
...
RegisterNetEvent("qb-gangmenu:server:depositMoney", function(amount)
	...
	if Player.Functions.RemoveMoney("cash", amount, 'BossMenu: Gang Deposit') then
		local gang = Player.PlayerData.gang.name
		AddGangMoney(gang, amount)
		if amount >= 25000 then
			TriggerEvent("qb-log:server:CreateLog", "bossmenu", "Funds Deposit ("..gang..")", "green", "**"..Player.PlayerData.charinfo.firstname .. " ".. Player.PlayerData.charinfo.lastname.. "** [ "..GetPlayerName(src) .. "(** Citizen ID: "..Player.PlayerData.citizenid.." | ID: "..Player.PlayerData.source..")** deposited **£" .. amount .. " into the " .. gang .. " account", true)
		else
			TriggerEvent("qb-log:server:CreateLog", "bossmenu", "Funds Deposit ("..gang..")", "green", "**"..Player.PlayerData.charinfo.firstname .. " ".. Player.PlayerData.charinfo.lastname.. "** [ "..GetPlayerName(src) .. "(** Citizen ID: "..Player.PlayerData.citizenid.." | ID: "..Player.PlayerData.source..")** deposited **£" .. amount .. " into the " .. gang .. " account", false)
		end
