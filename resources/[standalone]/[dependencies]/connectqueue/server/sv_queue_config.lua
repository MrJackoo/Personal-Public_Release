...
Config.Language = {
    ...
    whitelist = {
        ...
        noRole = "\xE2\x9D\x97 [Queue] Error: You must join our discord to join this server. Please join here DISCORD_INVITE_LINK",
...
Config.discordServerGuild = "SERVER_ID_HERE" -- Discord Server ID to check it if player is in the server
Config.discordBotToken = "SECRET_BOT_TOKEN_HERE"  -- Discord Token Bot - You Can Create at https://discord.com/developers/applications


Config.Roles = {
	role1 = {
		roleID = "ROLE_ID1", --Role ID
		point = 300,  -- any bigger point can push player on the first row of queue
	},
	role2 = {
		roleID = "ROLE_ID2", --Role ID
		point = 200,  -- any bigger point can push player on the first row of queue
	},
	role3 = {
		roleID = "ROLE_ID3", --Role ID
