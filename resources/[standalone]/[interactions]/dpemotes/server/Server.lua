...
QBCore.Commands.Add('staffanim', 'Play a staff emote', {}, false, function(source)
    TriggerClientEvent('customanimation:dialog', source)
end, "admin")

QBCore.Commands.Add('stopstaff', 'Stop a staff emote', {}, false, function(source)
    TriggerClientEvent('customanimation:stop', source)
end, "admin")