...
# inventory used with QBCore Framework
...
# How to install inventory
* Download source files from github
* Drag source files into your resources folder
* Rename folder from `inventory-main` to `inventory`

# Key Features
* ALL IMAGES FOLLOW THE SAME DIMENSIONS
* Easy Photoshop guideline template for creating custom images within inventory
...
# Previews
### simple guideline psd provided (found in main directory inventory)
![inventory Guideline](https://user-images.githubusercontent.com/91661118/146315681-c67f542d-e2bc-43ca-9957-7f1971b84268.png)
### full inventory
