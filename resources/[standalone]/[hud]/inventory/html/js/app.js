        ...
        if (itemData.name == "id_card") {
            ...
            if (itemData.info.type == "casing") {
                $(".item-info-description").html(
                    ...
                    itemData.info.identifier +
                    "</span></p><p><strong>Caliber: </strong><span>" +
                    itemData.info.ammolabel +
                    "</span></p><p><strong>Gun Imprint: </strong><span>" +
                    itemData.info.barrelprint +
                    "</span></p><p><strong>Crime scene: </strong><span>" +
                    itemData.info.street +
                    "</span></p><br /><p>" +
                    itemData.description +
                    "</p><p style=\"font-size:11px\"><b>Weight: </b>" + itemData.weight + " | <b>Amount: </b> " + itemData.amount
                );
            ...
            $(".item-info-title").html('<p>' + itemData.label + '</p>')
            $(".item-info-description").html('<p>Species: ' + itemData.info.species + ' </p>Type: ' + itemData.info.type);
            ...
            $(".item-info-title").html('<p>'+itemData.label+'</p>')
            $(".item-info-description").html('<p><strong></strong><span>Door No: ' + itemData.info.HouseId + '</span></p>');
        } else {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
